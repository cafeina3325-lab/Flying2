      ...
      <div className="min-h-[60vh]">
        {activeTab === "portfolio" ? (
          <div className="space-y-8">
            ...
            <div className="border-b border-[rgba(181,154,90,0.18)] pb-1 mb-8">
              <div className="flex overflow-x-auto pb-2 -mb-px space-x-8 scrollbar-hide">
                <button
                  onClick={() => selectGenre("ALL")}
                  className={`whitespace-nowrap pb-4 text-sm font-bold uppercase tracking-widest border-b-2 transition-colors ${selectedGenres.length === 0
                    ? "border-gold-antique text-gold-antique"
                    : "border-transparent text-white-dim hover:text-white-muted hover:border-white/20"
                    }`}
                >
                  ALL
                </button>
                {GENRES.map((g) => (
                  <button
                    ...
                    className={`whitespace-nowrap pb-4 text-sm font-bold uppercase tracking-widest border-b-2 transition-colors ${selectedGenres.includes(g)
                      ? "border-gold-antique text-gold-antique"
                      : "border-transparent text-white-dim hover:text-white-muted hover:border-white/20"
                      }`}
                  >
