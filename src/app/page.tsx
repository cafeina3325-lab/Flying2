      ...
      <main className="relative z-10 w-full h-full overflow-x-hidden">
        ...
        >
          ...
          <div className="w-full max-w-6xl px-4 sm:px-6">
            ...
            {/* Main Glass Panel */}
            <div className="relative rounded-[2rem] bg-[linear-gradient(135deg,rgba(58,42,31,0.4),rgba(15,31,26,0.4))] backdrop-blur-2xl p-6 sm:p-10 shadow-[0_0_40px_-5px_rgba(181,154,90,0.15)]">
        ...
        >
          ...
          <div className="w-full max-w-6xl px-4 sm:px-6">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] bg-[linear-gradient(135deg,rgba(58,42,31,0.4),rgba(15,31,26,0.4))] backdrop-blur-2xl p-8 sm:p-12 shadow-[0_0_40px_-5px_rgba(181,154,90,0.15)]">
        ...
        >
          ...
          <div className="w-full max-w-6xl px-4 sm:px-6">
            ...
            <div className="relative rounded-[2rem] bg-[linear-gradient(135deg,rgba(58,42,31,0.4),rgba(15,31,26,0.4))] backdrop-blur-2xl p-8 sm:p-12 shadow-[0_0_40px_-5px_rgba(181,154,90,0.15)] mb-20">
              {/* Steps Grid */}
              <motion.div
                initial="hidden"
                whileInView="visible"
              ...
              >
                {[
                  ...
                  <motion.div
                    ...
                    className="group relative p-8 rounded-[2rem] bg-[#D6BE8A]/5 border border-gold-soft/20 hover:border-gold-soft hover:bg-[#D6BE8A]/10 hover:-translate-y-1 transition-all duration-300 backdrop-blur-sm shadow-[0_4px_20px_rgba(0,0,0,0.2)]"
                  >
